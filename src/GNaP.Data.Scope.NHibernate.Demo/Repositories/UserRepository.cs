namespace GNaP.Data.Scope.NHibernate.Demo.Repositories
{
    ...
    using GNaP.Data.Scope.NHibernate.Demo.DomainModel;
    using GNaP.Data.Scope.NHibernate.Demo.SessionFactories;
    using GNaP.Data.Scope.NHibernate.Implementation;
    ...
    {
        private readonly IAmbientDbContextLocator<ISession> ambientContextLocator;

        private ISession Session
        {
            get
            {
                var session = ambientContextLocator.GetFromFactory<UserSessionFactory>();
        ...
        public UserRepository(NHibernateAmbientContextLocator ambientContextLocator)
        {
            if (ambientContextLocator == null) throw new ArgumentNullException("ambientContextLocator");
            this.ambientContextLocator = ambientContextLocator;
        }
        ...
        {
            throw new NotSupportedException("NHibernate does not allow async fetching");
        }
