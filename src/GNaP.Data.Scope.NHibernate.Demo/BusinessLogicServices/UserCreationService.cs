namespace GNaP.Data.Scope.NHibernate.Demo.BusinessLogicServices
{
	...
	{
        private readonly NHibernateScopeFactory factory;
		private readonly IUserRepository _userRepository;

        public UserCreationService(NHibernateScopeFactory factory, IUserRepository userRepository)
		{
		...
		public void CreateUser(UserCreationSpec userToCreate)
		{
			 ...
			 */
            using (var dbContextScope = factory.Create()) {
                //-- Build domain model
                var user = new User() {
                    Id = userToCreate.Id,
